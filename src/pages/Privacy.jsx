 ...
 *
 * Describes what the site actually does today. It has not been reviewed by a
 * lawyer; a legal review (retention period, regional obligations such as the
 * DPDP Act or GDPR) is recommended, and the text must change whenever the
 * form or analytics change.
 */
const Privacy = () => {
  ...
  const sections = [
    {
      ...
      body: [
        'When you submit the Start a Project form we collect the information you enter: the service you are interested in, your business type, your region, an optional budget (currency and approximate amount), an optional timeline, your project description, and your contact details (name, optional company, email address, and phone number with country code).',
    ...
    },
    {
      ...
      body: [
        'We do not sell your information. We do not share it with advertisers or data brokers. We do not add you to a marketing list because you made an inquiry.',
    ...
    },
    {
      ...
      body: [
        'Your inquiry is delivered to the Gen Clover team. We use third-party infrastructure to host this website and to deliver inquiry notifications; those providers process the data on our behalf and only for that purpose.',
      ],
    },
    {
      title: 'How long we keep it',
      body: [
        'We keep inquiry records for as long as needed to respond and to maintain a record of our conversation. If you would like your inquiry deleted, email us and we will remove it.',
      ],
    },
    {
      title: 'Your rights',
